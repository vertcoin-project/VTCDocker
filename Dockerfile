...
RUN apt-get -y install librsvg2-bin libtiff-tools bsdmainutils imagemagick libcap-dev libz-dev libbz2-dev python3-setuptools libtinfo5
RUN apt-get -y install libevent-dev libgmp-dev
